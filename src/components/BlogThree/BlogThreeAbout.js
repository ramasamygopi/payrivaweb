...
import '../BlogOne/BlogOne.css';
import Blogthree from './BlogThree.json';
import {Link} from 'react-router-dom';
const BlogThreeAbout=()=>{
    ...
    const filteredPosts = Blogthree.filter((post) => {
      ...
      <div className='Blog-Container'>
        ...
        <nav aria-label="Page navigation example">
            <ul className="pagination justify-content-center mt-10 mb-10">
                <Link to="/blogtwo"><li className="page-item d">
                <a className="page-link" href="#" tabindex="-1">Pre</a> </li>
                </Link>  
                ...
                <Link to="/blogfour"> <li className="page-item">
