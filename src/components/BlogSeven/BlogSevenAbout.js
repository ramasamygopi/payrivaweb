...
import Blogseven from './BlogSeven.json';
import {Link} from 'react-router-dom';
const BlogSevenAbout=()=>{
    ...
    const filteredPosts = Blogseven.filter((post) => {
    ...
    <Link to="/blogsix">
        <li className="page-item "><a className="page-link" href="#" tabindex="-1">Pre</a></li>
    </Link>  
